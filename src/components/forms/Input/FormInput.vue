...
<template>
    <div :class="[wrapperClass, width]">
        ...
        <div :class="fieldClass">
            <!-- Input wrapper -->
            <div class="relative">
                <input v-model="value" :type="inputType" :inputmode="inputmode" :placeholder="placeholder"
                    :required="required" @blur="handleBlur"
                ...
                <span v-if="isPassword" @click="showPassword = !showPassword"
