  ...
  <aside :class="[
    ...
    <div :class="[
      ...
      <router-link to="/admin/dashboard">
        <h3 v-if="isExpanded || isHovered || isMobileOpen"
          className="dark:text-white text-brand-600 h-[40px] font-semibold text-2xl tracking-wide">
          Settle
        ...
        <AvatarText v-else text="SK" size="11" />
      </router-link>
    </div>
