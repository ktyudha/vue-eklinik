<template>
  <div>
        ...
        <div>
          ...
          <div class="grid grid-cols-1 gap-4 lg:grid-cols-2 lg:gap-7 2xl:gap-x-32">
            <div>
              ...
              <Skeleton :loading="item == null" height="h-8" width="lg:min-w-sm w-full">
            ...
            <div>
              ...
              <Skeleton :loading="item == null" height="h-8" width="lg:min-w-sm w-full">
                <p class="text-sm font-medium text-gray-800 dark:text-white/90">{{ item?.phone_number ?? '-' }}</p>
              </Skeleton>
            </div>
            ...
            <div>
              ...
              <Skeleton :loading="item == null" height="h-8" width="lg:min-w-sm w-full">
                <p class="text-sm font-medium text-gray-800 dark:text-white/90">Semoga lelah menjadi lillah {{ "<3" }}
                    </p>
              </Skeleton>
            </div>
          </div>
    ...
    <Modal :is-open="isOpen" @close="closeModal" class="w-full max-w-[700px]">
